...
- `/admin/system/package-manager`: clean LuCI compat route in normal use. Adapter evidence exists for parsed installed package inventory, LuCI translation-package filtering, available package browser, available-upgrades planning, manual package-name/URL/staged-file install planning, overwrite/autoremove option plumbing, package-feed search, structured APK/OPKG feed editor, package-index update, and guarded install/remove plan actions; user routing remains compat until browser package-file upload, rollback, and mutation test coverage reach parity.
