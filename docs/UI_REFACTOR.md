...
- `/admin/system/package-manager`: clean LuCI compat route in normal use. Adapter evidence exists for parsed installed package inventory, package dependency/detail views, LuCI translation-package filtering, available package browser, available-upgrades planning, manual package-name/URL/staged-file install planning, browser package-file upload staging for `.apk`/`.ipk`, guarded package-name/URL/staged-file install apply with typed confirmation, staged untrusted-signature opt-in, overwrite/autoremove option plumbing, package-feed search, structured APK/OPKG feed editor, package-index update, guarded install/remove plan actions, structured typed confirmation for package mutations, async job polling for long package operations, package state fingerprints before/after actions, and post-mutation HTTP smoke for newly installed LuCI app routes; user routing remains compat until rollback coverage and mutation UX reach parity for broader package workflows.
