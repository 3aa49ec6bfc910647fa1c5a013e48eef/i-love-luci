...
- `/admin/system/system`: native editor for hostname, description, timezone, logging, and basic NTP settings, plus modern summaries for local time, Dropbear, uHTTPd, LEDs, and certificate defaults.
