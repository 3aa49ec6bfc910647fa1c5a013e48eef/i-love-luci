...
- `/admin/network/firewall` and firewall child routes: modern firewall defaults editor plus summaries for zones, forwardings, traffic rules, and redirects, with LuCI compat retained for advanced firewall forms.
...
- Firewall is native for defaults editing and summary views. Zone/rule/redirect create/edit/delete, custom rule files, nft include handling, validation, and full save/apply parity remain LuCI compat until the generic form/pending-change adapter is complete.
