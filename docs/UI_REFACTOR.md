...
- `/admin/services/uhttpd`: uHTTPd service status, lifecycle actions, common and advanced multi-instance web-server editor, listener/web-server summary, service activity log table, and UCI summary are available as native preview; auto mode defaults to LuCI compat until certificate upload/remove parity is complete.
