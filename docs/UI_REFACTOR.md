...
- `/admin/system/system`: native editor for hostname, description, timezone, logging, NTP settings, LuCI language/theme/table-filter/session/apply rollback timing, and uHTTPd certificate defaults, plus modern summaries for local time, Dropbear, uHTTPd, and LEDs.
