...
export function nativePathFor(path: string) {
	const nativePaths: Record<string, string> = {
		...
		"/admin/services/banip/allowlist": "/native/service/banip",
		"/admin/services/banip/blocklist": "/native/service/banip",
		"/admin/services/banip/feeds": "/native/service/banip",
		"/admin/services/banip/setreport": "/native/service/banip",
		"/admin/services/banip/firewall_log": "/native/service/banip",
